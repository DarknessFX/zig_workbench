...
//   Mike Shah - https://www.youtube.com/watch?v=wANU_8naFt8
...
fn InitializeProgram() void {
  ...
  gAppWindow = sdl.SDL_CreateWindow("SDL3 OpenGL: [Arrow,Pg Down/Up]=Position, [1..6]=Rotation, [IJKLUO]=Scale", gScreenWidth, gScreenHeight, sdl.SDL_WINDOW_OPENGL);
  if (gAppWindow == null) {
