// COPY of GLAD.H replacing <> with "" to make it easy to use with ZLS (Zig
// Language Server, VSCode), before this changes the auto-complete did not work.

/*

    OpenGL loader generated by glad 0.1.36 on Sat Jun 29 13:45:15 2024.
