...
//   Mike Shah - https://www.youtube.com/watch?v=hLv5T2loDZw
...
fn VertexSpecification() void {
  ...
  const vertexPositionsLen = 9;
  const vertexPositions = @Vector(vertexPositionsLen, sdl.GLfloat){
  //  x     y    z
  ...
  sdl.glBufferData(
    ...
    vertexPositionsLen * @sizeOf(sdl.GLfloat), // Size of data in bytes
