...
// Credits : 
//   [Episode 24] Projection Matrix and glm::Projection
//   Mike Shah - https://www.youtube.com/watch?v=EoJoRByb68w
...
\\uniform mat4 u_Projection;  // Perspective
\\
\\out vec3 v_colors;
\\
\\void main() {
...
fn PreDraw() void {
  ...
  g_uModelMatrix = glm.MatrixTranslate(g_uOffset);

  // Transfer g_uOffset (CPU) to u_Offset (GPU, Shaders)
...
fn CreateGraphicsPipeline() void {
  ...
  // Check if glGetUniformLocation was successful
  ...
  const fov: f32 = glm.radian(45.0); // Field of view angle in radians
