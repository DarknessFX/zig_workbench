...
//   Mike Shah - https://www.youtube.com/watch?v=QjmPjT-Iheg
...
fn Draw() void {
  ...
  // Render data
  sdl.glDrawArrays(sdl.GL_TRIANGLES, 0, 6);
...
fn VertexSpecification() void {
  ...
  // x|r   y|g   z|b
    ...
    -0.5,  0.5,  0.0,   // vertex 3, top left
     0.0,  0.0,  1.0,   // color
  // Second Triangle
     0.5, -0.5,  0.0,   // vertex 4, bottom righ
     0.0,  1.0,  0.0,   // color
     0.5,  0.5,  0.0,   // vertex 5, top right
     1.0,  0.0,  0.0,   // color
    -0.5,  0.5,  0.0,   // vertex 6, top left
     0.0,  0.0,  1.0,   // color
  };
