//!zig-autodoc-section: textures_logo_raylib.Main
//! raylib_examples/textures_logo_raylib.zig
...
pub fn main() !u8 {
  ...
  ray.InitWindow(screenWidth, screenHeight, "raylib [textures] example - texture loading and drawing");

  // NOTE: Textures MUST be loaded after Window initialization (OpenGL context is required)
  const texture = ray.LoadTexture(getPath("textures", "resources/raylib_logo.png"));        // Texture loading
