...
SET addCSourceFile=lib/zlib/adler32.c lib/zlib/compress.c lib/zlib/crc32.c lib/zlib/deflate.c lib/zlib/gzclose.c lib/zlib/gzlib.c lib/zlib/gzread.c lib/zlib/gzwrite.c lib/zlib/inflate.c lib/zlib/infback.c lib/zlib/inftrees.c lib/zlib/inffast.c lib/zlib/trees.c lib/zlib/uncompr.c lib/zlib/zutil.c 
