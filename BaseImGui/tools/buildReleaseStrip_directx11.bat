...
SET extra_args=-lgdi32 -ldwmapi -ld3d11 -ld3dcompiler_47 -I lib/cimgui -I lib/cimgui/imgui -I lib/DX11
...
SET addCSourceFile=lib/imgui/dcimgui.cpp lib/imgui/dcimgui_impl_dx11.cpp lib/imgui/dcimgui_impl_win32.cpp lib/imgui/dcimgui_memory_editor.cpp lib/imgui/imgui.cpp lib/imgui/imgui_widgets.cpp lib/imgui/imgui_draw.cpp lib/imgui/imgui_tables.cpp lib/imgui/imgui_demo.cpp lib/imgui/imgui_impl_win32.cpp lib/imgui/imgui_impl_dx11.cpp 
