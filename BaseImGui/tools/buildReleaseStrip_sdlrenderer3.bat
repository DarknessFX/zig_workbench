...
SET extra_args=-lgdi32 -ldwmapi -lsdl3 -L lib/SDL3 -I lib/SDL3/include
...
SET addCSourceFile=lib/imgui/cimgui.cpp lib/imgui/cimgui_impl_sdl3.cpp lib/imgui/cimgui_impl_sdlrenderer3.cpp lib/imgui/imgui.cpp lib/imgui/imgui_widgets.cpp lib/imgui/imgui_draw.cpp lib/imgui/imgui_tables.cpp lib/imgui/imgui_demo.cpp lib/imgui/imgui_impl_sdl3.cpp lib/imgui/imgui_impl_sdlrenderer3.cpp
