...
SET addCSourceFile=lib/imgui/cimgui.cpp lib/imgui/cimgui_impl_sdl2.cpp lib/imgui/cimgui_impl_opengl2.cpp lib/imgui/cimgui_memory_editor.cpp lib/imgui/imgui.cpp lib/imgui/imgui_widgets.cpp lib/imgui/imgui_draw.cpp lib/imgui/imgui_tables.cpp lib/imgui/imgui_demo.cpp lib/imgui/imgui_impl_sdl2.cpp lib/imgui/imgui_impl_opengl2.cpp
