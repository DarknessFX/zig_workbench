...
SET extra_args=-lgdi32 -ldwmapi -lsdl2 -L lib/SDL2 -I lib/SDL2/include
...
SET addCSourceFile=lib/imgui/cimgui.cpp lib/imgui/cimgui_impl_sdl2.cpp lib/imgui/cimgui_impl_sdlrenderer2.cpp lib/imgui/imgui.cpp lib/imgui/imgui_widgets.cpp lib/imgui/imgui_draw.cpp lib/imgui/imgui_tables.cpp lib/imgui/imgui_demo.cpp lib/imgui/imgui_impl_sdl2.cpp lib/imgui/imgui_impl_sdlrenderer2.cpp
