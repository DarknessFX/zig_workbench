...
CIMGUI_IMPL_API bool cimgui::cImGui_ImplWGPU_Init(WGPUDevice device, int num_frames_in_flight, WGPUTextureFormat rt_format)
{
    return ::ImGui_ImplWGPU_Init(device, num_frames_in_flight, rt_format);
}

CIMGUI_IMPL_API bool cimgui::cImGui_ImplWGPU_InitEx(WGPUDevice device, int num_frames_in_flight, WGPUTextureFormat rt_format, WGPUTextureFormat depth_format)
{
    return ::ImGui_ImplWGPU_Init(device, num_frames_in_flight, rt_format, depth_format);
}
