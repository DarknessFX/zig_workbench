...
CIMGUI_IMPL_API int32_t cimgui::cImGui_ImplAndroid_HandleInputEvent(cimgui::AInputEvent* input_event)
{
    return ::ImGui_ImplAndroid_HandleInputEvent(reinterpret_cast<::AInputEvent*>(input_event));
}
