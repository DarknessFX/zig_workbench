...
CIMGUI_IMPL_API bool cImGui_ImplVulkan_CreateFontsTexture(VkCommandBuffer command_buffer);
CIMGUI_IMPL_API void cImGui_ImplVulkan_DestroyFontUploadObjects(void);
