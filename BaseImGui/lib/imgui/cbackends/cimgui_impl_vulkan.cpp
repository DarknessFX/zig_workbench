...
CIMGUI_IMPL_API bool cimgui::cImGui_ImplVulkan_CreateFontsTexture(VkCommandBuffer command_buffer)
{
    return ::ImGui_ImplVulkan_CreateFontsTexture(command_buffer);
}

CIMGUI_IMPL_API void cimgui::cImGui_ImplVulkan_DestroyFontUploadObjects(void)
{
