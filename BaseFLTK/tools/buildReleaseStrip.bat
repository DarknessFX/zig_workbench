...
SET extra_args=-I"%CD%" -I"%CD%/lib" -I"%CD%/lib/GL" -I"%CD%/lib/CFLTK/include" -L"%CD%/lib/CFLTK" -L"%CD%/lib/FLTK" -lws2_32 -lcomctl32 -lgdi32 -lgdiplus -loleaut32 -lole32 -luuid -lshell32 -ladvapi32 -lcomdlg32 -lwinspool -luser32 -lkernel32 -lodbc32 -lcfltk2 -lfltk -lfltk_images -lfltk_jpeg -lfltk_png -lfltk_z 
