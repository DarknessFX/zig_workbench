...
SET extra_args=-lgdi32 -ldwmapi -lopengl32 -lSDL3 -lSDL3_ttf -lSDL3_image -L"%CD%\lib\SDL3" -I"%CD%\lib" -I"%CD%\lib\imgui" -I"%CD%\lib\SDL3\include"
...
SET addCSourceFile=lib/imgui/dcimgui.cpp lib/imgui/dcimgui_impl_sdl3.cpp lib/imgui/dcimgui_impl_opengl3.cpp lib/imgui/dcimgui_memory_editor.cpp lib/imgui/imgui.cpp lib/imgui/imgui_widgets.cpp lib/imgui/imgui_draw.cpp lib/imgui/imgui_tables.cpp lib/imgui/imgui_demo.cpp lib/imgui/imgui_impl_sdl3.cpp lib/imgui/imgui_impl_opengl3.cpp
...
REM OUTPUT A COPY OF ZIG BUILD COMMMAND
