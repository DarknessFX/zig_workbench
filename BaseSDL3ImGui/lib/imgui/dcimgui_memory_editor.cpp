...
namespace cimgui
{
#include "dcimgui_memory_editor.h"
}
...
CIMGUI_API const char* cimgui::MemoryEditor_DataFormatGetDesc(const cimgui::MemoryEditor* self, cimgui::MemoryEditor_DataFormat data_format)
{
...
CIMGUI_API void*       cimgui::MemoryEditor_EndiannessCopyBigEndian(void* _dst, void* _src, size_t s, int is_little_endian)
{
    return ::MemoryEditor::EndiannessCopyBigEndian(_dst, _src, s, is_little_endian);
}

CIMGUI_API void*       cimgui::MemoryEditor_EndiannessCopyLittleEndian(void* _dst, void* _src, size_t s, int is_little_endian)
{
    return ::MemoryEditor::EndiannessCopyLittleEndian(_dst, _src, s, is_little_endian);
}

CIMGUI_API void*       cimgui::MemoryEditor_EndiannessCopy(const cimgui::MemoryEditor* self, void* dst, void* src, size_t size)
{
    return reinterpret_cast<const ::MemoryEditor*>(self)->EndiannessCopy(dst, src, size);
}

CIMGUI_API const char* cimgui::MemoryEditor_FormatBinary(const cimgui::MemoryEditor* self, const ImU8* buf, int width)
{
    return reinterpret_cast<const ::MemoryEditor*>(self)->FormatBinary(buf, width);
}

CIMGUI_API void        cimgui::MemoryEditor_DrawPreviewData(const cimgui::MemoryEditor* self, size_t addr, const ImU8* mem_data, size_t mem_size, ImGuiDataType data_type, cimgui::MemoryEditor_DataFormat data_format, char* out_buf, size_t out_buf_size)
{
