...
// EDITED BY DARKNESSFX
// - Struct padding cause errors in Zig cImport, 
// - WGpuVertexState change to size_t to fix zig error "padding size with 4bytes to alignment boundary" 
// Changes commented or removed to be able to compile with Zig.
...
//typedef void (*WGpuGetCompilationInfoCallback)(WGpuDevice device, void *userData);
