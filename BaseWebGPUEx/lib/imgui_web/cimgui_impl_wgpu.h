...
//DFX
CIMGUI_IMPL_API void cImGui_ImplWGPU_SetShaders(WGPUShaderModule frag, WGPUShaderModule vertex);
CIMGUI_IMPL_API WGPUProgrammableStageDescriptor cImGui_ImplWGPU_CreateProgrammableStage(WGPUShaderModule shader_module);
