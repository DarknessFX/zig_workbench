//!zig-autodoc-section: BaseRaylibImGui.Build
//! BaseRaylibImGui\\build.zig :
//!   Build Template using RayLib and RayGUI and Dear ImGui.
...
const projectname: []const u8 = "BaseRayLibImGui";
...
pub fn buildWindows(b: *std.Build, target: std.Build.ResolvedTarget, optimize: std.builtin.OptimizeMode) void {
  ...
  const c_srcs = .{
    ...
    "lib/raylib/include/rlImGui.cpp",
