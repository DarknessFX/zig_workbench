...
//=============================================================================
  ...
  exe.root_module.addIncludePath( b.path("lib/ode") );
  exe.root_module.addLibraryPath( b.path("lib/ode") );
  exe.root_module.linkSystemLibrary("ode_double", .{});
