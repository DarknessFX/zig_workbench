...
SET extra_args=-I"D:\Program Files\VulkanSDK\Include" -I"D:\Program Files\VulkanSDK\Include\vulkan" -L"D:\Program Files\VulkanSDK\lib" -lvulkan-1 -I"%CD%" -I"%CD%\lib\glfw" -Llib\glfw -lglfw3 -lgdi32
...
COPY /Y %CD%\triangle_frag.spv  %CD%\bin\ReleaseStrip\ >nul
COPY /Y %CD%\triangle_vert.spv  %CD%\bin\ReleaseStrip\ >nul
